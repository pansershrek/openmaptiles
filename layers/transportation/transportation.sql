...
FROM (
        -- etldoc: osm_transportation_merge_linestring_gen_z8  ->  layer_transportation:z4
        -- etldoc: osm_transportation_merge_linestring_gen_z8  ->  layer_transportation:z5
        -- etldoc: osm_transportation_merge_linestring_gen_z8  ->  layer_transportation:z6
        -- etldoc: osm_transportation_merge_linestring_gen_z8  ->  layer_transportation:z7
        -- etldoc: osm_transportation_merge_linestring_gen_z8  ->  layer_transportation:z8
         ...
         WHERE zoom_level in (4, 5, 6, 7, 8)
         UNION ALL

         -- etldoc: osm_highway_linestring_gen_z9  ->  layer_transportation:z9
         -- etldoc: osm_highway_linestring_gen_z9  ->  layer_transportation:z10
         -- etldoc: osm_highway_linestring_gen_z9  ->  layer_transportation:z11
         SELECT osm_id,
                geometry,
                highway,
                construction,
